...
WORKFLOW_IMAGE_PATH="workflow/Qwen IMAGE Edit 2509 Three Image Edit_api (2).json"
WORKFLOW_2IMAGE_TO_IMAGE="workflow/QWen_skin_fixlora.json"
WORKFLOW_IMAGE_POSE="workflow/Qwen_changepose_api.json"
WORKFLOW_IMAGE_PATH_1Image="workflow/QWen_skin_fixlora_1image_api.json"
WORKFLOW_INPAINT="workflow/Qwen Inpaint InstantX Acceleration V2 (1)_api.json"
# =======================================
